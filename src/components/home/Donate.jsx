  ...
  return (
    ...
    className='w-[90%] mx-auto p-12 max-sm:p-7 bg-[#D7D7D7] flex flex-row max-sm:flex-col rounded-lg'>
      ...
      <div className='flex min-sm:m-auto max-sm:pl-30'>
           <Link to="/donations"><button className='justify-center items-center text-center m-auto bg-indigo-900 hover:bg-indigo-950 text-white px-5 w-[150px] h-[47px] md:w-[170px] md:h-[47px] rounded-2xl max-md:w-[200px] max-md:h-[55px] '>
      Donate
            </button></Link>
      </div>
    </motion.div>
