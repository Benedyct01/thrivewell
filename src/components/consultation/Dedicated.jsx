...
const Dedicated = () => {
  return (
    ...
    <section className='bg-[#C7DFE7] max-lg:mb-10'>
        <div className='w-full flex flex-1/2 flex-col-reverse md:flex-row p-15 md:p-5 lg:p-20 md:gap-2 lg:gap-20 xl:gap-50'>
            <div className='w-full md:w-[36%] lg:w-[36%] flex flex-col gap-7 max-md:items-center max-md:justify-center max-md:text-center'>
                <div className='max-md:hidden flex flex-col gap-3 md:mt-[50%]'>
                  <div className="h-px size-5 w-30 bg-black">
                  </div>
                    <p className=' text-sm text-[#515151] tracking-widest font-semibold'>Meet a Doctor</p>
                </div>
                <h2 className='font-light text-2xl md:text-3xl'>We're Dedicated To Your Well-Being</h2>
                ...
                <button className='h-[50px] w-[170px] rounded-2xl bg-[#010080] hover:bg-indigo-950 text-white'>Contact Us</button>
            </div>
            ...
            <div className='min-md:hidden min-w-[60%] items-center justify-around mx-auto grid grid-cols-2 gap-2 p-9 mt-15'>
            ...
            <div className='min-md:hidden flex flex-col gap-3 mt-[10%] ml-auto'>
                    <p className='text-sm text-[#515151] tracking-widest font-semibold'>Meet a Doctor</p>
                    <div className="h-px size-5 w-30 bg-black">
                  </div>
                </div>
