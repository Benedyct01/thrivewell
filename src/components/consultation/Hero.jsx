...
const Hero = () => {
  return (
    <>
        <section>
          <div className='flex flex-row max-md:flex-col bg-[#C7DFE7] h-screen'>
          <div className='max-sm:w-[80%] md:w-[45%] lg:w-[50%] flex flex-col max-sm:p-10 p-20 mt-20 min-lg:h-[100vh] min-lg:gap-5 min-xl:p-25 gap-3'>
    ...
    <p className='text-sm lg:text-[17px] text-[#313030]'>Tired of long hospital waits? Online healthcare consultations offer a faster alternative.</p>
