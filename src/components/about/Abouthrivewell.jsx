  ...
  return (
    ...
    <section>
        <div className='flex flex-col-reverse md:flex-row mt-20 gap-5 max-md:flex max-md:justify-center max-md:items-center max-md:p-5'>
            <div className='w-full md:w-[53%] flex justify-center items-center md:items-start md:justify-start rounded-3xl max-md:p-5' 
                style={{
        ...
        <div className='w-full md:w-[47%] flex flex-col-reverse md:flex-col p-5 md:p-9 max-md:flex max-md:justify-center max-md:items-center'>
...
<p className='text-neutral-700 text-lg md:text-4xl mt-1 md:mt-5 font-semibold max-md:text-center'>About Thrivewell</p>
        ...
        <div className='w-full md:w-[47%] flex flex-col p-5 md:p-11'>
...
<button className='max-md:hidden h-[47px] w-[150px] rounded-2xl  mt-3 bg-[#010080] hover:bg-indigo-950 text-white text-center text-sm'>About Us</button>
        ...
        <div className='w-full md:w-[53%] flex justify-center items-center md:justify-end md:items-end' 
                style={{
