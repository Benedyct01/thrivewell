...
const Conditionguides = () => {
  return (
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/diabetes.png" className='w-full h-[163px]' />
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/heartdisease.png" className='w-full h-[163px]' />
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/depression.png" className='w-full h-[163px]' />
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/cardiacarrestman.png" alt="" className='w-full h-[163px]' />
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/arthritis.png" className='w-full h-[163px]' />
    ...
    <div className='bg-white group hover:bg-[#79AEBE]'>
        <img src="/cancer.png" className='w-full h-[163px]' />
